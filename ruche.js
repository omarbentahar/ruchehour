...
function toggle_yesterday_info() {
    var affichageinfosveille = document.getElementById("resultats-veille").style.display;

    if (affichageinfosveille === "none") {
        affichageinfosveille = "block";
        document.getElementById("bouton-veille").value = "Cacher Infos";
    } else {
        affichageinfosveille = "none";
        document.getElementById("bouton-veille").value = "Ruche de la veille";
    }
}
...
// function untype() {
// 	document.getElementById("comb1").style.height = "125px";
// 	document.getElementById("comb1").style.width = "125px";
// 	document.getElementById("comb1").style.left = "1px";
// 	document.getElementById("comb1").style.top = "52px";
// 	document.getElementById("comb2").style.height = "125px";
// 	document.getElementById("comb2").style.width = "125px";
// 	document.getElementById("comb2").style.left = "83px";
// 	document.getElementById("comb2").style.top = "6px";
// 	document.getElementById("comb3").style.height = "125px";
// 	document.getElementById("comb3").style.width = "125px";
// 	document.getElementById("comb3").style.left = "165px";
// 	document.getElementById("comb3").style.top = "52px";
// 	document.getElementById("comb4").style.height = "125px";
// 	document.getElementById("comb4").style.width = "125px";
// 	document.getElementById("comb4").style.left = "1px";
// 	document.getElementById("comb4").style.top = "146px";
// 	document.getElementById("comb5").style.height = "125px";
// 	document.getElementById("comb5").style.width = "125px";
// 	document.getElementById("comb5").style.left = "83px";
// 	document.getElementById("comb5").style.top = "194px";
// 	document.getElementById("comb6").style.height = "125px";
// 	document.getElementById("comb6").style.width = "125px";
// 	document.getElementById("comb6").style.left = "165px";
// 	document.getElementById("comb6").style.top = "146px";
// 	document.getElementById("comb7").style.height = "125px";
// 	document.getElementById("comb7").style.width = "125px";
// 	document.getElementById("comb7").style.left = "83px";
